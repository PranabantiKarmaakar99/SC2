    ...
    for (let i = 0; i < buttons.length; i++) {
        ...
        buttons[i].addEventListener("click", function () {
           ...
           if (value == "CE") {
            ...
            // else if (prevValue2  && S_buttonTextArray.includes(currentValue.slice(S_buttonTextArray.length-1)) && numberTextArray.includes(value)   ) {
                
            //     console.log("I am here ok6")
            //     prevValue2 = "Ans = " + currentValue;
            //     display2.value = prevValue2;
            ...
            else if (prevValue2  &&  numberTextArray.includes(value) && S_buttonTextArray.includes(currentValue.slice(-1 ) && currentValue!==0) )
            
            {
                ...
                console.log("CurrentValueslice:",currentValue.slice(-1));
                
                console.log("I am here ok7")
                prevValue2 = "Ans = " + currentValue;
                display2.value = prevValue2;
            ...
            else if (prevValue2  &&  numberTextArray.includes(value) && currentValue.slice(-1)==="^" )
            ...
            else if (prevValue2  &&  numberTextArray.includes(value) && prevValue2.slice(-1)==="^" )
